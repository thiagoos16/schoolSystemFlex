...
@section("content")
    <div class="container">
        <div class="row">
            <form method="POST" action="{{ url('aluno/create') }}" class="col s12">
                <div class="row">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input placeholder="Ex: 69087590" id="cep" name="cep" type="number" class="validate" onblur="pesquisacep(this.value);">
                ...
                <div class="row">
                    <div class="input-field col s6">
                        <input placeholder="" id="rua" name="rua" type="text" class="validate">
                        <label for="rua">Rua</label>
                    </div>
                    <div class="input-field col s6">
                        <input placeholder="" id="numero" name="numero" type="number" class="validate">
